...
og_file = 'world_data_hult_regions.xlsx'
data_set= pd.read_excel(og_file)
file2 = 'API_VC.IHR.PSRC.P5_DS2_en_excel_v2_10181485.xls'
...
for i in country_list:
    countryinfo = indicators1.loc[indicators1["Country Code"]==i] #find all the corresponding data who's country codes match the country code in our Central Africa 1 datafram
...
tax_data = pd.read_excel('world_data_hult.xlsx')
...
central_africa1.to_excel('central_africa1_fillNA.xlsx')
